...
let _0x134a17 = new Date(),
    ...
    _0x5bc515 = "ksjsb",
    _0x180c0c = "",
    ksjsbjk = "https://qianxun01.coding.net/p/ks/d/qx/git/raw/master/7w.json",
...
async function _0x505e51() {
  const c = {
    'url': "https://gh.mse.workers.dev/https://raw.githubusercontent.com/goovoz/carry/KS/backup/ks.json",
    'headers': ''
  };
  await _0x39a23b("get", c);
  let p = _0x1a0963;
...
function Envcc(T, c) {
  const p = {
    ...
    'dceom': 'ijzfe',
    'JighY': 'updateMsg',
    'uwDzR': "https://gh.mse.workers.dev/https://raw.githubusercontent.com/goovoz/carry/KS/backup/ks.json",
    'CvmUM': function (S, a) {
      return S === a;
    },
    'QfLFC': "JwVvM",
    ...
    [p["QrmhW"]](S, a) {
      if (p["JpIGP"]('ViWHE', p["NOwog"])) {
        if (p["QwtqA"](q, i[p["LTEld"]])) {
          d = true;
          u = "https://gh.mse.workers.dev/https://raw.githubusercontent.com/goovoz/carry/KS/backup/ks.json";
